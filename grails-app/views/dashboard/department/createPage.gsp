...
<div class="wrapper">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="department_name" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="department_simpleName" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
    ...
    <script>
        ...
        function searchInfo() {
            ...
            $.post("/department/createTemple",{name:name,staffNumber:number,departmentCode:departmentCode,createID:postID}, function(data) {
        ...
        function saveDepartment() {
            ...
            $.post("/department/createNewDepartment",{name:name,simpleName:simpleName,upperCode:upperCode}, function(data) {
                alert(data.message);
                console.log(data.postID);
                postID=data.postID;
                $("#hiddenID").val(data.postID);
            }, "json");
        }
