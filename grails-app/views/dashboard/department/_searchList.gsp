<div class="box-body">
    ...
    <script>
        ...
        function saveCharge(staffID) {
            var department_id=$("#idHidden").val();
            console.log('choose ID:'+staffID+" "+department_id);
            $.post("/department/saveCharge",{staffID:staffID,departmentID:department_id}, function(data) {
                alert(data.message);
            }, "json");
        }
    </script>
