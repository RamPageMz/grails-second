<div class="box-body">
    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <g:each in="${searchList}">
            <tr onclick="showDetail('${it?.staff_number}')">
    ...
    <script>
        ...
        function showDetail(staffNumber) {
            console.log('aa:'+staffNumber);
            $.post("/salaryInfo/showDetail",{staffNumber:staffNumber}, function(data) {
                $("#salaryInfoList").html(data);
            }, "html");
        }
    </script>
</div>